...
namespace Clinical_Trial_Task_Manager.Controllers
{
    public class StudiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Sponsor,StartDate,Status")] Study study)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Sponsor,StartDate,Status")] Study study)
        {
            if (id != study.Id)
            {
                return NotFound();
